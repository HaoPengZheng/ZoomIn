    ...
    <div class='people-content analysisDropStyle'>
        <el-row> 
            ...
            <el-col :span="12">
                ...
                <div class="el-input el-input-group el-input-group--prepend">
                    ...
                    <div style="border-bottom: 1px solid #D0D0D0;height: 40px;text-align: left;margin-top:0px" @drop='colDrop($event)' @ondrop="removeDrop($event)" @dragover='allowDrop($event)' @ondragstart="drag(event)">
        ...
        <el-row>
                <div class="el-input el-input-group el-input-group--prepend" v-show="axisFlag">
                    ...
                    <div style="border-bottom: 1px solid #D0D0D0;height: 40px;text-align: left;margin-top:0px" @drop='colAxisDrop($event)' @ondrop="removeDrop($event)" @dragover='allowDrop($event)' @ondragstart="drag(event)">
